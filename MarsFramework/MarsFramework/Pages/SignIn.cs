    ...
    class SignIn
    {
        ...
        internal void LoginSteps()
        {
            ...
            if (text == "Mars Logo")
            {
                ...
                String img = SaveScreenShotClass.SaveScreenshot(GlobalDefinitions.driver, "Login_Pass");
            ...
            { 
                ...
                String img1 = SaveScreenShotClass.SaveScreenshot(GlobalDefinitions.driver, "Login_Fail");
